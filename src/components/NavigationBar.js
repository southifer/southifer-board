    ...
    return (
        ...
        >
            <svg
                ...
                strokeWidth={1.5}
                stroke="currentColor"
                className={`w-6 h-6 transform transition-transform ${isNavOpen ? 'rotate-180' : ''}`}
            >
        ...
        <div className={`lg:flex ${isNavOpen ? 'block' : 'hidden'} lg:flex lg:space-x-2 lg:ml-auto flex-col lg:flex-row space-y-2 lg:space-y-0 mt-4 lg:mt-0 w-full lg:w-auto`}>
            ...
            >
                <svg
                    ...
                    viewBox="0 0 24 24"
                    fill="currentColor"
                    className={`w-5 h-5 mr-2 ${pathname === '/dashboard' ? 'text-[#8570FF]' : 'text-white'}`}
                >
            ...
            <Link
                to="/controller"
                className={`flex items-center px-4 py-2 rounded-lg ${pathname === '/controller' ? 'bg-[#111827]' : 'hover:bg-[#111827]'}`}
            >
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    fill="currentColor"
                    className={`w-5 h-5 mr-2 ${pathname === '/controller' ? 'text-[#8570FF]' : 'text-white'}`}
                >
            ...
            <Link
                to="/config"
                className={`flex items-center px-4 py-2 rounded-lg ${pathname === '/config' ? 'bg-[#111827]' : 'hover:bg-[#111827]'}`}
            >
                <svg 
                    xmlns="http://www.w3.org/2000/svg" 
                    width="16" 
                    ...
                    fill="currentColor" 
                    viewBox="0 0 16 16"
                    className={`w-5 h-5 mr-2 ${pathname === '/config' ? 'text-[#8570FF]' : 'text-white'}`}
                >
            ...
            <Link
                to="/bot"
                className={`flex items-center px-4 py-2 rounded-lg ${pathname === '/bot' ? 'bg-[#111827]' : 'hover:bg-[#111827]'}`}
            >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={`w-5 h-5 mr-2 ${pathname === '/bot' ? 'text-[#8570FF]' : 'text-white'}`}>
            ...
            <Link
                to="/farm"
                className={`flex items-center px-4 py-2 rounded-lg ${pathname === '/farm' ? 'bg-[#111827]' : 'hover:bg-[#111827]'}`}
            >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={`w-5 h-5 mr-2 ${pathname === '/farm' ? 'text-[#8570FF]' : 'text-white'}`}>
            ...
            <Link
                to="/script"
                className={`flex items-center px-4 py-2 rounded-lg ${pathname === '/script' ? 'bg-[#111827]' : 'hover:bg-[#111827]'}`}
            >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={`w-5 h-5 mr-2 ${pathname === '/script' ? 'text-[#8570FF]' : 'text-white'}`}>
            ...
            <Link
                to="/router"
                className={`flex items-center px-4 py-2 rounded-lg ${pathname === '/router' ? 'bg-[#111827]' : 'hover:bg-[#111827]'}`}
            >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={`w-5 h-5 mr-2 ${pathname === '/router' ? 'text-[#8570FF]' : 'text-white'}`}>
